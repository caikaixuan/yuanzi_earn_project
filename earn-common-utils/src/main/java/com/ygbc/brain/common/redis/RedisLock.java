...
import com.ygbc.brain.common.utils.DateTimeUtils;
...
public class RedisLock implements Lock {
    ...
    public boolean tryLockWithTime(long timeout, TimeUnit unit) throws InterruptedException {
        ...
        try {
            ...
            do {
                Long i = redisManager.setnx(lockKey, DateTimeUtils.formatDate(DateTimeUtils.now(), DateTimeUtils.FORMAT_TIMESTAMP_FORMAT));
